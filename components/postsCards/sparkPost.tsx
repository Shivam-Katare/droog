...
import { Card } from '../ui/card'; // Assuming you have a Card component in your UI library
...
function SparkPosts() {
  ...
  const { generatedContent, savePost } = useStore();
  ...
  const handleSaveClick = () => {
    setIsEditing(false);
    if (user_id) {
      savePost({ userName, user_id, postContent: content, post_type: 'Spark' });
    } else {
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <Sheet>
                    <SheetTrigger>
                        <WandSparkles className='cursor-pointer'/>
                    </SheetTrigger>
                    <SheetContent>
                      <SheetHeader>
